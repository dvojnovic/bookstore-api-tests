...
public class AuthorsApiTests {
    ...
    public void testGetAuthorById() {
        ...
        Assert.assertEquals(response.jsonPath().getString("firstName"), "First Name 1");
    }
    ...
    public void testCreateAuthor() {
        ...
        Assert.assertEquals(response.statusCode(), 200, "Expected status code 200");
        Assert.assertEquals(response.jsonPath().getInt("id"), 9999);
    ...
    public void testUpdateAuthor() {
        Author updatedAuthor = new Author(9999, 1, "Jane", "Smith");

        Response response = ApiClient.put("/Authors/" + 9999, updatedAuthor);
    ...
    public void testDeleteAuthor() {
        Response response = ApiClient.delete("/Authors/" + 9999);

        Assert.assertEquals(response.statusCode(), 200, "Expected status code 200");

        Response check = ApiClient.get("/Authors/" + 9999);

        Assert.assertEquals(check.statusCode(), 404, "Expected status code 404");
    }
